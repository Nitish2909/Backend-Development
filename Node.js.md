...
```bash
 ...
 ```bash
 //Synchronous Way
 // CRUD operation using fs module in node.js

const fs= require('fs');

// //How to create a file and write data with async way.
// fs.writeFileSync("files/simple.txt","Hello from fsCurd.js file.this is an example of how to create and read async file with the help WriteFileSync method");

// //create another file
// fs.writeFileSync("./files/simple2.txt","this is asimple file")

// //Read async file
// const data = fs.readFileSync("./files/simple.txt","utf-8");
// console.log(data);

// //update file data
// fs.appendFileSync("./files/simple2.txt"," This is an example of how to update file data.");

// //delete async file
// fs.unlinkSync("./files/simple2.txt","utf-8");
